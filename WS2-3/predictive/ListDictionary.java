...
public class ListDictionary implements Dictionary{
	 ...
	 * When instantiate a ListDictionary object, the dictionary will be
	 * read from the provided path to the arraylist
	...
	/**
	 * This method reads a given signature and utilise a binary search to
	 * find the stored words with the corresponding signature
